...
void installDragAndDrop() {
  ...
  ..installAll(querySelectorAll('.container'))
  ..accept.add(dragGroup1)
  ..onDrop.listen((DropzoneEvent event) {
    event.dropzone.querySelector('span').text = 'dropped ' + event.draggable.getAttribute("data-drag-label");
  });
  
  DropzoneGroup dropGroup2 = new DropzoneGroup()
  ..installAll(querySelectorAll('.child'))
